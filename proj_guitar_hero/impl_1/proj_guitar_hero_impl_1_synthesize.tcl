...
global para
set para(gui_mode) 1
set para(prj_dir) "//vs-home/npower03/GitHub/es4-guitar-hero/proj_guitar_hero"
# synthesize IPs
# synthesize VMs
...
run_postsyn [list -a iCE40UP -p iCE40UP5K -t SG48 -sp High-Performance_1.2V -oc Industrial -top -w -o proj_guitar_hero_impl_1_syn.udb proj_guitar_hero_impl_1.vm] "//vs-home/npower03/GitHub/es4-guitar-hero/proj_guitar_hero/impl_1/proj_guitar_hero_impl_1.ldc"
